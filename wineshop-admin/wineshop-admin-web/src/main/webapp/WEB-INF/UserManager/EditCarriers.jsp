...
<div class="modal-body no-padding" id="formCarriers">
    <form class="smart-form">
        <fieldset style="max-height:600px; overflow-x: hidden; overflow-y: auto;">
            <section>
                <div class="row">
                    <label class="label col col-2">运营商名</label>
                    <div class="col col-10" style="margin-top: 7px;">
                        {{model.name}}
                    </div>
                </div>
            </section>
            <secition>
                <div class="row" style="margin-bottom: 15px;">
                    <label class="label col col-2">绑定手机</label>
                    <div class="col col-4" style="margin-top: 7px;">
                        {{model.userName}}
                    </div>
                </div>
            </secition>
...
<script type="text/javascript">
    (function () {
        var lm = new EditPage("#formCarriers", {
            getAjax: {
                url: '${pageContext.request.contextPath}/api/carriers/get?id=${id}',
                method: 'GET'
            },
            editAjax: {
            ...
            beforeBinding: function () {
                var m = {
                    personName: lm.model.personName,
                    personPhone: lm.model.personPhone,
                    userName: lm.model.userName,
                    id: lm.model.id,
                    name: lm.model.name
                };
                var tmp = lm.model;
                ...
                lm.vm.area = tmp.city === null ? CommonBase.getCityInfo("") : tmp.city;
