                            ...
                            <fieldset>
                                <div class="row">
                                    <section class="col col-3">
                                        ...
                                        <label class="input">
                                            <select class="input-sm" style="width:200px" v-combox="_run('query.pinpaiId',{
                url:'<%=Constants.APIS_WEBSITE%>/pinpaiMain/pinpaiList?Status=20',
                method:'GET',
                defaultOption:{label:'全部',value:''},
                data:{},
                label:'name',
                value:'id'
            })"></select>
                            ...
                            <footer>
                                ...
                                <a class="btn btn-success header-btn hidden-mobile fa fa-plus xxx atncol_a"
                                   href="${pageContext.request.contextPath}/adv/pinpai/edit?id=0&typeCode=${typeCode}"
                            ...
                            <div id="dt_basic_wapper" class="dataTables_wrapper form-inline no-footer"
                                ...
                                <table id="dt_basic_advList" class="table table-striped table-bordered table-hover"
                                    ...
                                    <tr>
                                        ...
                                        <th data-hide="phone,tablet" style="width:12%;text-align:center">品牌</th>
                                        <th data-hide="phone,tablet" style="width:12%;text-align:center">链接店铺</th>
                                        <th data-hide="phone,tablet" style="width:5%;text-align:center">点击量</th>
                                    ...
                                    <tr v-for="item in list">
                                        ...
                                        <td>{{(item.foreignName == null || item.foreignName == "") ?
                                            "-":item.foreignName }}
                                        </td>
                                        <td>{{item.clickCount}}</td>
                                        <td>
                                            <a class='tableBtn hidden-mobile'
                                               v-bind:href="'${pageContext.request.contextPath}/adv/pinpai/edit?typeCode=${typeCode}&id='+ item.id"
