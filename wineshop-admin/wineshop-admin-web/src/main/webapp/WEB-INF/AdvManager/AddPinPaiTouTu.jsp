...
<div class="modal-body no-padding" id="formToutus">
    <form class="smart-form">
        <fieldset style="max-height:600px; overflow-x: hidden; overflow-y: auto;">
            ...
            <section>
                <div class="row">
                    <label class="label col col-2">十大品牌</label>
                    <div class="col col-10">
                        <div class="">
                            <select class="input-sm Town" style="width:200px" v-combox="_run('model.brandId',
                                               {
                url:'<%=Constants.APIS_WEBSITE%>/pinpaiMain/pinpaiList?Status=20',
                method:'GET',
                data:{},
                defaultOption:{show:false},
                label:'name',
                value:'id',
                preLoad:true
            })"></select>
...
<script type="text/javascript">
    (function () {
        ...
        var lm = new EditPage("#formToutus", {
            ...
            include: ["foreignKey", "cityCode", "img", "id", "typeCode", "brandId"],
