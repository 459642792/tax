        ...
        <fieldset style="max-height:600px; overflow-x: hidden; overflow-y: auto;">
            ...
            <section>
                <div class="row">
                    ...
                    <div class="col col-10">
                        <select class="input-sm" id="Province" name="Province" style="width:200px">
                        </select>
            ...
            <section>
                <div class="row">
                    ...
                    <div class="col col-10">
                        <label class="input">
                            <i class="icon-append fa fa-fw fa-info-circle"></i>
                            <input  id="money" name="money" class="input" maxlength="4"
                                   placeholder="请输入发行面额" onkeyup="if(isNaN(value))execCommand('undo')"
                ...
                <div class="row">
                    ...
                    <div class="col col-10">
                        ...
                        <input id="costLimitMoney" name="costLimitMoney"
                               ...
                               maxlength="4" onkeyup="if(isNaN(value))execCommand('undo')"
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#submit').click(function () {
            ...
            $.post("${pageContext.request.contextPath}/couponMain/couponAdd", obj, function (data) {
                if (data.success) {
