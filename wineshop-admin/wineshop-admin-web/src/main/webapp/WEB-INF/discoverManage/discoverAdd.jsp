...
<input type="hidden" id="baseUrl" data-admin="${Power}" data-img-url="<%=Constants.IMAGE_UPLOAD_URL%>"
...
<script type="text/javascript" src="discoverManage/js/discoverAdd.js"></script>
