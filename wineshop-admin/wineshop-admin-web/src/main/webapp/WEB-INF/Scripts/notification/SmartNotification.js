...
$.SmartMessageBox = function (a, b) {
    ...
    if (e = 1, 0 == isIE8orlower()) {
        ...
        $.sound_on && (f.pause(), f.play())
    }
    SmartMSGboxCount += 1,
    0 == ExistMsg && (ExistMsg = 1, c = "<div class='divMessageBox animated fadeIn fast' id='MsgBoxBack'></div>", $("body").append(c), 1 == isIE8orlower() && $("#MsgBoxBack").addClass("MessageIE"));
    var g = "", h = 0;
    if (void 0 != a.input)
    ...
    d = "<div class='MessageBoxContainer animated fadeIn fast' id='Msg" + SmartMSGboxCount + "'>",
        ...
        d += g, d += "<div class='MessageBoxButtonSection'>",
