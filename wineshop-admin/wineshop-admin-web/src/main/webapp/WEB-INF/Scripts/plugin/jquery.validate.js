    ...
    a.extend(a.fn, {
                    ...
                    this.submit(function (b) {
                        function d() {
                            ...
                            if (c.settings.submitHandler) {
                                if (c.submitButton) {
                                    d = a("<input type='hidden'/>").attr("name", c.submitButton.name).val(c.submitButton.value).appendTo(c.currentForm)
                                }
        ...
        a.extend(a.validator, {
            ...
            messages: {
                ...
                minlength: a.validator.format("����������{0}���ַ�"),
            ...
            prototype: {
                ...
                defaultMessage: function (b, c) {
                    return this.findDefined(this.customMessage(b.name, c),
                        ...
                        a.validator.messages[c], "<strong>Warning: No message defined for " + b.name + "</strong>")
                },
                ...
                showLabel: function (b, c) {
                    ...
                    d.length
                        ...
                        : (
                            d = a("<" + this.settings.errorElement + ">").attr("for", this.idOrName(b)).addClass(this.settings.errorClass).html(c || ""),
                    ...
                    !c && this.settings.success && (d.text(""),
                        "string" == typeof this.settings.success ? d.addClass(this.settings.success) : this.settings.success(d, b)), this.toShow = this.toShow.add(d)
                },
                        ...
                        a.ajax(a.extend(!0, {
                            ...
                            success: function (d) {
                                ...
                                if (g) {
                                    ...
                                    f.prepareElement(c),
                                        f.formSubmitted = h, f.successList.push(c),
