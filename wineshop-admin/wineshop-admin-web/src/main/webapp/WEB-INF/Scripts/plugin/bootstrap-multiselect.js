...
!function (a) {
    ...
    if ("undefined" != typeof ko && ko.bindingHandlers && !ko.bindingHandlers.multiselect) {
    ...
    b.prototype = {
        defaults: {
            buttonText: function (b) {
                ...
                if (b.length > 3)
                    return b.length + " " + this.nSelectedText + ' <b class="caret"></b>';
                var c = "";
                b.each(function () {
                    var b = void 0 !== a(this).attr("label") ? a(this).attr("label") : a(this).html();
                    c += b + ", "
                })
                return c.substr(0, c.length - 2) + ' <b class="caret"></b>'
            },
        ...
        constructor: b, buildContainer: function () {
            this.$container = a(this.options.buttonContainer)
        },
        buildButton: function () {
            this.$button = a(this.templates.button).addClass(this.options.buttonClass),
        ...
        buildDropdownOptions: function () {
            this.$select.children().each(a.proxy(function (b, c) {
                ...
                a("li input", this.$ul).on("change", a.proxy(function (b) {
                    ...
                    if (c) {
                        ...
                        if (this.options.multiple) {
                            ...
                            this.options.selectedClass && a(h).parents("li").removeClass(this.options.selectedClass),
                                a(h).prop("checked", !1),
                                g.prop("selected", !1),
                                this.$button.click()
                        }
                        "active" == this.options.selectedClass && g.parents("a").css("outline", "")
                    ...
                    this.updateButtonText(),
                        this.$select.change(),
                        this.options.onChange(f, c);
                    return this.options.preventInputChangeEvent ? !1 : void 0
                }, this)),
                a("li a", this.$ul).on("touchstart click", function (b) {
        ...
        createOptionValue: function (b) {
            ...
            a("label", f).addClass(e),
                a("label", f).append('<input type="' + e + '" />');
            var g = a(b).prop("selected") || !1,
                h = a("input", f);
            h.val(d),
            d == this.options.selectAllValue && h.parent().parent().addClass("multiselect-all"),
                a("label", f).append(" " + c),
                this.$ul.append(f),
            a(b).is(":disabled") && h.attr("disabled", "disabled").prop("disabled", !0).parents("li").addClass("disabled"), h.prop("checked", g),
            g && this.options.selectedClass && h.parents("li").addClass(this.options.selectedClass)
        },
