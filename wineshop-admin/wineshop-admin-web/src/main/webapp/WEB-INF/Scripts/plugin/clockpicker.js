...
!function () {
    ...
    function d(d, g) {
        function i(a, b) {
            var c = l.offset(), d = /^touch/.test(a.type), f = c.left + r, i = c.top + r,
                k = (d ? a.originalEvent.touches[0] : a).pageX - f, m = (d ? a.originalEvent.touches[0] : a).pageY - i,
                p = Math.sqrt(k * k + m * m), q = !1;
            if (!b || !(s - u > p || p > s + u)) {
                a.preventDefault();
                ...
                j && l.append(B.canvas), B.setHand(k, m, !b, !0), h.off(n).on(n, function (a) {
                    a.preventDefault();
                    var b = /^touch/.test(a.type), c = (b ? a.originalEvent.touches[0] : a).pageX - f,
                        d = (b ? a.originalEvent.touches[0] : a).pageY - i;
                    (q || c !== k || d !== m) && (q = !0, B.setHand(c, d, !1, !0))
                }), h.off(o).one(o, function (a) {
                    a.preventDefault();
                    var c = /^touch/.test(a.type), d = (c ? a.originalEvent.changedTouches[0] : a).pageX - f,
        ...
        this.id = c("cp"),
            ...
            this.hoursView = p,
            this.minutesView = q,
            this.spanHours = k.find(".clockpicker-span-hours"),
            this.spanMinutes = k.find(".clockpicker-span-minutes"),
        g.autoclose || f('<button type="button" class="btn btn-sm btn-default btn-block clockpicker-button">' + g.donetext + "</button>").click(f.proxy(this.done, this)).appendTo(k),
        "top" !== g.placement && "bottom" !== g.placement || "top" !== g.align && "bottom" !== g.align || (g.align = "left"), "left" !== g.placement && "right" !== g.placement || "left" !== g.align && "right" !== g.align || (g.align = "top"), k.addClass(g.placement),
            k.addClass("clockpicker-align-" + g.align),
            this.spanHours.click(f.proxy(this.toggleView, this, "hours")),
            this.spanMinutes.click(f.proxy(this.toggleView, this, "minutes")),
            z.on("focus.clockpicker click.clockpicker", f.proxy(this.show, this)),
            A.on("click.clockpicker",
        ...
        for (C = 0; 60 > C; C += 5)
            D = F.clone(), E = C / 30 * Math.PI, D.css({
        ...
        if (j) {
            ...
            J.setAttribute("class", "clockpicker-svg"),
                J.setAttribute("width", v),
                J.setAttribute("height", v);
            var K = a("g");
            ...
            N.setAttribute("class", "clockpicker-canvas-bg"),
                N.setAttribute("r", u);
            var O = a("circle");
            O.setAttribute("class", "clockpicker-canvas-fg"),
    ...
    d.DEFAULTS = {
        ...
        d.prototype.locate = function () {
            var a = this.element, b = this.popover, c = a.offset(), d = a.outerWidth(), e = a.outerHeight(),
                f = this.options.placement, g = this.options.align, h = {};
            switch (b.show(), f) {
                case "bottom":
                    h.top = c.top + e;
                    break;
        ...
        d.prototype.resetClock = function (a) {
            var b = this.currentView, c = this[b], d = "hours" === b, e = Math.PI / (d ? 6 : 30), f = c * e,
                g = d && c > 0 && 13 > c ? t : s, h = Math.sin(f) * g, i = -Math.cos(f) * g, k = this;
        ...
        d.prototype.setHand = function (a, c, d, e) {
            var g, h = Math.atan2(a, -c), i = "hours" === this.currentView, k = Math.PI / (i || d ? 6 : 30),
                l = Math.sqrt(a * a + c * c), m = (this.options, i && (s + t) / 2 > l), n = m ? t : s;
        ...
        d.prototype.done = function () {
            ...
            c !== a && (this.input.triggerHandler("change"),
        ...
        f.fn.clockpicker = function (a) {
            ...
            return this.each(function () {
                ...
                if (e)
                    "function" == typeof e[a] && e[a].apply(e, b);
                else {
