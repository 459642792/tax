...
!function (a) {
    ...
    b.prototype = {
                ...
                for (h = 0; h < i.length; h++) {
                    ...
                    for (j = 0; j < k.length; j++) {
                        ...
                        1 == m.toggle && (n = ' data-toggle="button"'),
                            l.append('<button class="' + q + ' btn-default btn-sm" title="' + m.title + '" tabindex="' + r + '" data-provider="' + e + '" data-handler="' + o + '"' + n + '><span class="' + m.icon + '"></span> ' + p + "</button>"),
                            f.push(o),
                            g.push(m.callback)
                    }
                    c.append(l)
        ...
        __handle: function (b) {
            ...
            a(b.currentTarget).focus(),
                h(this), f.indexOf("cmdSave") < 0 && this.$textarea.focus(),
                b.preventDefault()
        },
        showEditor: function () {
            var b,
            ...
            if (null == this.$editor) {
                ...
                i.buttons.length > 0 && (k = this.__buildButtons(i.buttons, k)),
                i.additionalButtons.length > 0 && (k = this.__buildButtons(i.additionalButtons, k)),
                    j.append(k);
                if (e.is("textarea"))
                    ...
                    var l = "function" == typeof toMarkdown ? toMarkdown(e.html()) : e.html(),
                        m = a.trim(l);
                    b = a("<textarea/>", {"class": "md-input", val: m}),
                        j.append(b),
                        f.el = e,
                ...
                if (i.savable) {
                    var n = a("<div/>", {"class": "md-footer"}),
                        o = "cmdSave";
                    g.push(o),
                        h.push(i.onSave),
                        n.append('<button class="btn btn-success" data-provider="' + d + '" data-handler="' + o + '"><i class="fa fa-check"></i> Save</button>'),
                        j.append(n)
                }
                ...
                this.$editor.show();
            i.autofocus && (this.$textarea.focus(), this.$editor.addClass("active"));
            i.onShow(this);
            return this
        },
        showPreview: function () {
            var b,
                ...
                e = this.$textarea,
                f = e.next(),
                g = a("<div/>", {"class": "md-preview", "data-provider": "markdown-preview"});
            this.$isPreview = !0;
            this.disableButtons("all").enableButtons("cmdPreview");
            b = "string" == typeof d ? d : "object" == typeof markdown ? markdown.toHTML(e.val()) : e.val();
            g.html(b);
        ...
        replaceSelection: function (a) {
            ...
            if ("selectionStart" in b) {
                fn = function () {
                    b.value = b.value.substr(0, b.selectionStart) + a + b.value.substr(b.selectionEnd, b.value.length);
        ...
        getNextTab: function () {
            ...
            "function" == typeof b ? a = b() : "object" == typeof b && b.length > 0 && (a = b);
            return a
        },
            ...
            switch (a.keyCode) {
                ...
                case 9:
                    ...
                    if (null != c) {
                        ...
                        if (e.start == e.end && e.end == this.getContent().length) {
                            b = !1
                        }
                        else {
            ...
            c.addClass("active"),
                a(document).find(".md-editor").each(function () {
                    if (a(this).attr("id") != c.attr("id")) {
                        var b = a(this).find("textarea").data("markdown");
            ...
            buttons: [[{
                ...
                data: [{
                    ...
                    callback: function (a) {
                        ...
                        if ("**" == e.substr(d.start - 2, 2) && "**" == e.substr(d.end, 2)) {
                            a.setSelection(d.start - 2, d.end + 2), a.replaceSelection(b), c = d.start - 2
                        }
                        else {
                            a.replaceSelection("**" + b + "**"), c = d.start + 2
                        }
                ...
                },
                    {
                        ...
                        callback: function (a) {
                            ...
                            if ("*" == e.substr(d.start - 1, 1) && "*" == e.substr(d.end, 1)) {
                                a.setSelection(d.start - 1, d.end + 1), a.replaceSelection(b), c = d.start - 1;
                            }
                            else {
                    ...
                    },
                    {
                        ...
                        callback: function (a) {
                            ...
                            if (d = 4, "### " == g.substr(f.start - d, d) || (d = 3, "###" == g.substr(f.start - d, d))) {
                                a.setSelection(f.start - d, f.end), a.replaceSelection(b), c = f.start - dl
                            }
                            else {
                                if (e = g.substr(f.start - 1, 1), e && "\n" != e) {
                                    (a.replaceSelection("\n\n### " + b + "\n"), c = f.start + 6)
                                }
                                else {
            ...
            },
                {
                    ...
                    data: [{
                        ...
                        callback: function (a) {
                            ...
                            null != d && (a.replaceSelection("[" + b + "](" + d + ")"), c = e.start + 1, a.setSelection(c, c + b.length))
                        }
                    },
                        {
                            name: "cmdImage",
                            ...
                            callback: function (a) {
                                ...
                                if (null != d) {
                                    a.replaceSelection("![" + b + "](" + d + ' "enter image title here")'),
                                        c = e.start + 2,
                                        a.setNextTab("enter image title here"),
                                        a.setSelection(c, c + b.length);
                                }
                            }
                        }]
                },
                {
                    ...
                    data: [{
                        ...
                        callback: function (b) {
                            ...
                            if (0 == e.length) {
                                c = "list text here", b.replaceSelection("- " + c), d = e.start + 2;
                            }
                            else if (e.text.indexOf("\n") < 0) {
                                c = e.text, b.replaceSelection("- " + c), d = e.start + 2;
                            }
                            else {
                                var f = [];
                                f = e.text.split("\n"),
    ...
    var d = function (a) {
        ...
        e = function (b) {
            ...
            if (!("focusin" != b.type && "click" != b.type || 1 != e.length || "object" != typeof e[0])) {
                c = e[0].activeElement;
                if (!a(c).data("markdown")) {
                    if ("undefined" == typeof a(c).parent().parent().parent().attr("class") || a(c).parent().parent().parent().attr("class").indexOf("md-editor") < 0) {
                        if ("undefined" == typeof a(c).parent().parent().attr("class") || a(c).parent().parent().attr("class").indexOf("md-editor") < 0)
                            d = !0;
                    } else {
                        d = !1;
                    }
