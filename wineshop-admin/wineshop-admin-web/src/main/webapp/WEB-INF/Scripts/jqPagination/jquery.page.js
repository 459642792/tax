    ...
    var ms = {
        ...
        fillHtml: function (obj, args) {
            return (function () {
                ...
                /*样式*/
                obj.css({padding: '20px 0 20px 0', textAlign: 'left', color: '#ccc;'})
                obj.find('a').css({
                    borderRadius: '3px',
                ...
                obj.find('a').hover(function () {
                    ...
                    }).siblings('a').css({border: '1px solid #ddd'})
                }, function () {
                    $(this).css({border: '1px solid #53afff'})
                });
                obj.find('.current').css({
                    borderRadius: '3px',
                    display: 'inline-block',
                    height: '25px',
                    lineHeight: '25px',
