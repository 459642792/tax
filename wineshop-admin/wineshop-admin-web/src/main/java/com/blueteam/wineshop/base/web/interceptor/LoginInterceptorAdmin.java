 ...
 */
@Component
public class LoginInterceptorAdmin extends HandlerInterceptorAdapter {
    ...
    private static final Logger logger = LoggerFactory.getLogger(LoginInterceptorAdmin.class);

    static {
        logger.info("admin登录校验器加载start");
