...
public class MyValidator<T> {
    ...
    public static MyValidator<Object> newInstance() {
        return new MyValidator<Object>();
    }
     ...
     * @return
     */
    public MyValidator<T> isNotNullObj(Object target, String errorMessage) {
     ...
     * @return
     */
    public MyValidator<T> isNotEmptyStr(String target, String errorMessage) {
        if (hasErrors) return this;
     ...
     * @return
     */
    public MyValidator<T> isEmptyStr(String target, String errorMessage) {
        if (hasErrors) return this;
     ...
     * @return
     */
    public MyValidator<T> isNotBlankStr(String target, String errorMessage) {
        if (hasErrors) return this;
     ...
     * @return
     */
    public MyValidator<T> isBlankStr(String target, String errorMessage) {
        if (hasErrors) return this;
     ...
     * @return
     */
    public MyValidator<T> isMatch(boolean isMatch, String errorMessage) {
        if (hasErrors) return this;
     ...
     * @return
     */
    public MyValidator<T> pattern(String target, String regExp, String errorMessage) {
        if (hasErrors) return this;
     ...
     */
    public MyValidator<T> between(Integer target, double from, double to, String errorMessage) throws Exception {
        if (hasErrors) return this;
        if (from > to) {
     ...
     * @throws Exception 当from > to 时，抛出异常
     */
    public MyValidator<T> between(double target, double from, double to, String errorMessage) throws Exception {
        if (hasErrors) return this;
        if (from > to) {
            throw new Exception("The value of the parameter 'from' must be less than 'to' ! ");
        }
     ...
     * @return
     */
    public MyValidator<T> isLegalIdCard(String idCard, String errorMessage) {
        if (hasErrors) return this;
     ...
     * @throws Exception
     */
    public MyValidator<T> cmpStrDate(String date1, String date2, String dateFormat, int flag, String errorMessage) throws Exception {
        if (hasErrors) return this;
