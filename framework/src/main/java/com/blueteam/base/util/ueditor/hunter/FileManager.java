...
import com.blueteam.base.util.ueditor.define.MultiState;
...
public class FileManager {
    ...
    public State listFile(int index) {
        ...
        if (OSSClientProperties.useStatus) {
            ...
            // 从文件夹中获取文件
            if (!dir.exists()) {
                return new com.blueteam.base.util.ueditor.define.BaseState(false, AppInfo.NOT_EXIST);
            }

            if (!dir.isDirectory()) {
                return new com.blueteam.base.util.ueditor.define.BaseState(false, AppInfo.NOT_DIRECTORY);
            }
    ...
    private State getState(Object[] files) {
        ...
        com.blueteam.base.util.ueditor.define.BaseState fileState = null;
        ...
        for (Object obj : files) {
            ...
            file = (File) obj;
            fileState = new com.blueteam.base.util.ueditor.define.BaseState(true);
            fileState.putInfo("url", "/" + SystemUtil.getProjectName() + com.blueteam.base.util.ueditor.PathFormat.format(this.getPath(file)));
...
//			file = (File)obj;
            fileState = new com.blueteam.base.util.ueditor.define.BaseState(true);
            fileState.putInfo("url", com.blueteam.base.util.ueditor.PathFormat.format(OSSClientProperties.ossEndPoint + obj));
            state.addState(fileState);
        }
