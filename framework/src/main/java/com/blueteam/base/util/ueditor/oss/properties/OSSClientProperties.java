package com.blueteam.base.util.ueditor.oss.properties;
...
public class OSSClientProperties {
    ...
    public static String bucketName = "fjjh-oss";
    public static String key = "rgBGhs03VupDUUGB";
    public static String secret = "UFZDDSBq6qCsNmZv7HXUgGyLEqkhfn";
    public static boolean autoCreateBucket = false;

    public static String ossCliendEndPoint = "http://oss-cn-zhangjiakou.aliyuncs.com/";
    public static String ossEndPoint = "http://fjjh-oss.oss-cn-zhangjiakou.aliyuncs.com/";
