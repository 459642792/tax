...
import com.blueteam.base.help.wechatpay.config.WXPayConfig;
...
public class WXPayRequest {
     ...
     * @throws Exception
     */
    private String requestWithoutReport(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert, boolean autoReport) throws Exception {
        String result = requestOnce(config.getSingleDomain(), urlSuffix, uuid, data, connectTimeoutMs, readTimeoutMs, useCert);
        return result;
    }
...
//        return this.request(urlSuffix, uuid, data, connectTimeoutMs, readTimeoutMs, false, autoReport);
        return this.requestWithoutReport(urlSuffix, uuid, data, connectTimeoutMs, readTimeoutMs, false, autoReport);
    }
