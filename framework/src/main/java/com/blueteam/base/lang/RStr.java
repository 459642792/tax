...
public class RStr {
    ...
    public static String cutRight(String s, int width, char c) {
        if (null == s) return StringUtils.repeat(String.valueOf(c), width);
        int len = s.length();
        if (len == width) return s;
        if (len < width) return StringUtils.repeat(String.valueOf(c), width - len) + s;
    ...
    public static String alignRight(CharSequence cs, int width, char c) {
        ...
        return StringUtils.repeat(String.valueOf(cs), width - len) + cs;
    }
    ...
    public static String alignLeft(CharSequence cs, int width, char c) {
        ...
        return cs + StringUtils.repeat(String.valueOf(cs), width - length);
    }
    ...
    public static StringBuilder removeTail(StringBuilder sb, String suffix) {
        if (!StringUtils.endsWith(sb.toString(), suffix)) return sb;
